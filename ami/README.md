...
| <a name="input_install_efa_driver"></a> [install\_efa\_driver](#input\_install\_efa\_driver) | If `true`, the EFA driver will be installed on the instance. Defaults to `false` | `bool` | `false` | no |
| <a name="input_install_nvidia_driver"></a> [install\_nvidia\_driver](#input\_install\_nvidia\_driver) | If `true`, the NVIDIA driver will be installed on the instance. Defaults to `false` | `bool` | `false` | no |
